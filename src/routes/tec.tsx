...
import { FaCss3, FaHtml5, FaReact, FaLaravel } from "react-icons/fa";
import { SiTailwindcss, SiJavascript, SiShadcnui, SiReactrouter, SiVite, SiDjango } from "react-icons/si";
...
const TecPage = () => {
    ...
    return (
        <div className="w-full h-screen">
            <p className="pt-8 pl-8 text-3xl font-medium">
                Documentación que necesitaras a lo largo de tu carrera de desarrollo Web
            </p>
            <div className="grid grid-cols-4 grid-rows-4 p-8 align-middle justify-items-center">
                <a href="https://developer.mozilla.org/es/docs/Learn/HTML" target="_blank">
                <CardHome Text="HTML5" icon={<FaHtml5 className="w-16 h-16 text-orange-600"/>} />
                </a>
                <a href="https://developer.mozilla.org/es/docs/Learn/CSS" target="_blank">
                <CardHome Text="CSS" icon={<FaCss3 className="w-16 h-16 text-blue-600"/>} />
                </a>
                <a href="https://developer.mozilla.org/es/docs/Learn/JavaScript" target="_blank">
                <CardHome Text="JavaScript" icon={<SiJavascript className="w-16 h-16 text-yellow-400"/>} />
                </a>
                <a href="https://es.react.dev/" target="_blank">
                <CardHome Text="React" icon={<FaReact className="w-16 h-16 text-sky-700 animate-spin-slow"/>} />
                </a>
                <a href="https://ui.shadcn.com/docs" target="_blank">
                <CardHome Text="ShadcUI" icon={<SiShadcnui className="w-16 h-16"/>} />
                </a>
                <a href="https://react-icons.github.io/react-icons/" target="_blank">
                <CardHome Text="React-Icons" icon={<svg xmlns="http://www.w3.org/2000/svg" width={"4rem"} height={"4rem"} fill="none" viewBox="0 0 602 602">
                    <g>
                ...
                <CardHome Text="HeroIcons" icon={<IoShieldOutline className="w-16 h-16 text-violet-600"/>}/>
                </a>
                <a href="https://reactrouter.com/en/main/start/overview" target="_blank">
                <CardHome Text="React Router" icon={<SiReactrouter className="w-16 h-16 text-red-500"/>} />
                </a>
                <a href="https://vitejs.dev/guide/" target="_blank">
                <CardHome Text="Vite" icon={<SiVite className="w-16 h-16"/>} />
                </a>
                <a href="https://tailwindcss.com/" target="_blank">
                <CardHome Text="TailWindCSS" icon={<SiTailwindcss className="w-16 h-16 text-sky-500"/>} />
                </a>
                <a href="https://laravel.com/docs/11.x/readme" target="_blank">
                <CardHome Text="Laravel" icon={<FaLaravel className="w-16 h-16 text-orange-600"/>} />
                </a>
                <a href="https://docs.djangoproject.com/es/5.0/" target="_blank">
                <CardHome Text="Django" icon={<SiDjango className="w-16 h-16 text-black"/>} />
                </a>
